...
/**
 * AdminReusableBlocksMenu class.
 */
class AdminReusableBlocksMenu extends AbstractAdminMenu
{
	/**
	 ...
	 * @var string
	 */
	public const ADMIN_REUSABLE_BLOCKS_MENU_ICON = 'dashicons-welcome-widgets-menus';
	...
	{
		return \esc_html__('Reusable blocks', 'headlines');
	}
