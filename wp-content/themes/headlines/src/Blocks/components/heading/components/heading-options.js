...
export const HeadingOptions = (attributes) => {
	...
	const headingLevels = [
		{ label: 'H1', tooltip: __('Heading 1', 'headlines'), value: 1 },
		{ label: 'H2', tooltip: __('Heading 2', 'headlines'), value: 2 },
		{ label: 'H3', tooltip: __('Heading 3', 'headlines'), value: 3 },
		{ label: 'H4', tooltip: __('Heading 4', 'headlines'), value: 4 },
		{ label: 'H5', tooltip: __('Heading 5', 'headlines'), value: 5 },
		{ label: 'H6', tooltip: __('Heading 6', 'headlines'), value: 6 },
	];
	...
	return (
		<UseToggle {...generateUseToggleConfig(attributes, manifest, 'headingUse')}>
			...
			>
				{!hideColor &&
					<ColorPicker
						label={(!hideSize && !hideFontWeight) ? null : <IconLabel icon={icons.color} label={__('Color', 'headlines')} />}
				...
				{!hideFontWeight && fontSizes[fontSize]?.weightOptions?.length > 0 &&
					<Select
						...
						placeholder={__('Weight', 'headlines')}
						noBottomSpacing
						simpleValue
						noSearch
					/>
				...
				{!hideHeadingLevel &&
					<Menu
						...
						tooltip={__('Heading level', 'headlines')}
