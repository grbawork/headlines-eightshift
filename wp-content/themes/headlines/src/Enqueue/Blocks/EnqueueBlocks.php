 ...
 *
 * @package Headlines\Enqueue\Blocks
 */

declare(strict_types=1);

namespace Headlines\Enqueue\Blocks;

use Headlines\Config\Config;
use HeadlinesVendor\EightshiftLibs\Manifest\ManifestInterface;
use HeadlinesVendor\EightshiftLibs\Enqueue\Blocks\AbstractEnqueueBlocks;
